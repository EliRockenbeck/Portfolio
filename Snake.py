...
initialLength = 5
lengthPerApple = 1
dXSquare = 50 # size of each square, in pixels


dXScreen = int(1000 / dXSquare) # width of game screen, in squares
dYScreen = int(800 / dXSquare)
...
class Game():
    ...
    def showScore(self):
        print("you made it to the top", len(self.snakes))
    def tick(self):
        if self.paused:
            return
